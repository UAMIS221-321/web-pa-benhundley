...
function handleOnChange()
{
    ...
    {
        console.log(book.title + " with id of " + book.id);
        console.log(" and looking at " + book.id + " " + selectedId);
...
{
    myBook.numAvlb--;
    document.getElementById("bookAvbl").value = myBook.numAvlb;
    putBook(myBook.id);
}
...
{
    console.log(myBook.title, myBook.author, myBook.genre, myBook.numAvlb, myBook.isbn, myBook.length, myBook.cover)
